...
export class Executor {
     ...
     * @private
     */
    async _callLLMForToolSelection(messages, availableTools, provider) {
        ...
        try {
            // Call LLM with universal tools; provider will convert as needed
            console.log(`[Executor._callLLMForToolSelection] Calling LLM with ${universalTools.length} tools`);
            ...
            // Use provider-parsed tool calls if available
