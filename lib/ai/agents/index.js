 ...
 *
 * Exports:
 * - Agent classes: Router, Planner, Executor, Critic, Memory, Recovery
 ...
 *
 * Usage:
 * import { Router, Planner, Executor, loadAgent } from 'lib/ai/agents';
 * 
 * // Direct import
 ...
 * console.log(AGENT_REGISTRY.router.description);
 *
 * Notes:
...
export const AGENT_REGISTRY = {
    router: {
        class: Router,
        description: 'Intent classification and pipeline selection',
        defaults: {
            temperature: 0.7,
            maxRetries: 2,
            timeoutMs: 5000,
        ...
        responsibilities: [
            'Classify user intent (ANALYSIS | DEBUG | PLANNING | CODING | COMPLIANCE)',
            'Determine pipeline (FAST_PATH | FULL_PIPELINE)',
            'Route to appropriate agent or Explanation Engine',
        ],
    },
    planner: {
        class: Planner,
 ...
 * @param {string} agentType - Agent type (router, planner, executor, critic, memory, recovery)
...
export { Router, Planner, Executor, Critic, Memory, Recovery };