...
const AGENT_REGISTRY = {
    ...
    decision: {
        class: Decision,
        description: 'Continuation decision after each completed step',
        responsibilities: [
            'Decide whether to continue, stop, or modify the plan',
            'Skip remaining tasks when goal is already answered',
            'Inject new tasks when discovered facts require them',
        ],
    },
};
