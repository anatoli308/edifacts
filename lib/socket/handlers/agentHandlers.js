...
function _handleAgentInvoke(socket) {
    return async (request) => {
        ...
        try {
            ...
            // Run per-message EDIFACT analysis (deterministic, no LLM)
            const analysisChatObj = typeof socket.sessionContext.analysisChat?.toObject === 'function'
            ...
            const authenticatedUserObj = typeof socket.sessionContext.authenticatedUser?.toObject === 'function'
