 ...
 *   - If Ollama fails → try Anthropic (if available)
 ...
 * - Provider fallback order: Ollama → OpenAI → Anthropic → Explanation Engine
...
export class Recovery {
    constructor(config = {}) {
        this.config = {
            ...
            providerChain: ['ollama', 'openai', 'anthropic', 'explanation-engine'],
