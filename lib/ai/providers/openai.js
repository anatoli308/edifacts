        ...
        try {
            ...
            for await (const chunk of stream) {
                ...
                if (finishReason) {
                    ...
                    if (!chunk.usage) {
                        console.warn('[OpenAIAdapter] No usage data in final chunk. This may indicate an API version issue.');
                    }
                    ...
                    yield {
                        ...
                        usage: chunk.usage || null  // ✨ Include usage from final chunk (may be null)
                    };
